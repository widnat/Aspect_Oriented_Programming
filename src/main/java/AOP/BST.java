...
public class BST<T extends Comparable<? super T>>  {
    ...
    /**
     * Initializes the AOP.BST with the data in the Collection. The data in the AOP.BST
     ...
     * @param root Root of AOP.BST to find height for
     * @return Height of AOP.BST
     */
     ...
     * <p>
     * You may assume that you won't get a AOP.BST with a different generic type.
     * For example, if this AOP.BST holds Strings, then you will not get as an input
     * a AOP.BST that holds Integers.
     * <p>
     ...
     *
     * @param other the Object we are comparing this AOP.BST to
     * @return true if other is equal to this AOP.BST, false otherwise.
     */
     ...
     * @param a Root of first AOP.BST to compare
     * @param b Root of second AOP.BST to compare
     * @return boolean saying whether the 2 AOP.BST's are equal or not
     */
